...
class LoteAPIView(APIView):
    ...
    def post(self, request):
        ...
        if existeLote:
            return Response(f"El lote {request.data['Codigo_Lote']} ya existe!", status=status.HTTP_400_BAD_REQUEST)
    ...
    def put(self, request, id):
        ...
        if serializer.is_valid():
            ...
            return Response(f"Lote {lote.Codigo_Lote} actualizado con éxito!", status=status.HTTP_200_OK)
        return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
