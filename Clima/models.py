...
class Daily_Indicadores(models.Model):
    ...
    #Precipitation
    Precipitacion = models.DecimalField(max_digits=18, decimal_places=16, null=True)
    ...
    Temp_Below_Mean = models.DecimalField(max_digits=5, decimal_places=2,null=True)
    #Dew Temp
    ...
    Dew_Temp_At_Min_Temp = models.DecimalField(max_digits=5, decimal_places=2,null=True)
    #Normalized Difference Vegetative Index
    Ndvi = models.DecimalField(max_digits=5, decimal_places=2,null=True)
    #Evapotranspiration
    Evapotranspiration = models.DecimalField(max_digits=5, decimal_places=2,null=True)
    Evapotranspiration_Crop	 = models.DecimalField(max_digits=5, decimal_places=2,null=True)
    #Relative Humidity
    ...
    Relat_Hum_Max_Temp = models.DecimalField(max_digits=5, decimal_places=2,null=True)
    Relat_Hum_Min_Temp = models.DecimalField(max_digits=5, decimal_places=2,null=True)
    #Crop
    Crop_Water_Demand = models.DecimalField(max_digits=5, decimal_places=2,null=True)
    #Sushine Duration
    Sunshine_Duration = models.DecimalField(max_digits=5, decimal_places=2,null=True)	
    #Daily Light Integral
    Dli =models.DecimalField(max_digits=5, decimal_places=2,null=True)
    #Sea Level Pressure
    Sea_Level_Pressure = models.DecimalField(max_digits=5, decimal_places=2,null=True)
    #Vapor Pressure
    Vapor_Pressure = models.DecimalField(max_digits=5, decimal_places=2,null=True)
    Vapor_Pressure_Deficit = models.DecimalField(max_digits=5, decimal_places=2,null=True)
    #Shortwave Downwelling
    Shortwave_Downwelling = models.DecimalField(max_digits=5, decimal_places=2,null=True)
